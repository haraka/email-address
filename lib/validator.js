// Plain-address validator for web forms and general-purpose use.
//
// `parseAddress` is `parseEnvelope` with the envelope wrapping
// stripped: it requires a bare `local@domain` form, rejects angle
// brackets, source routes, comments, display names, address lists,
// groups, the null reverse-path, and the bare `postmaster` shortcut.
// `isValid` is the boolean wrapper that swallows the error.
