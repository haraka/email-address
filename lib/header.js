// RFC-5322 header-address parser.
//
// Hand-rolled recursive descent against §3.4 (address syntax) and §4.4
// (obsolete forms). The parser is lenient by default — it accepts the
// obs-* productions so legacy mailers continue to round-trip — and
// reuses the regex character classes defined for the envelope grammar.
...
import { parseAddressLiteral, toASCIIDomain } from './literals.js'
import { Address, Group, hasCtrl } from './address.js'
